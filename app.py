...
<section id="booking" style="padding: 6rem 0; background-color: #09090b; border-top: 1px solid rgba(255,255,255,0.05);">
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem; display: flex; flex-wrap: wrap; gap: 4rem;">
        <div style="flex: 1; min-width: 300px;">
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem; align-items: flex-start;">
                ...
                <div>
                    ...
                    <p style="color: #6b7280; margin: 0; font-size: 0.85rem; letter-spacing: 0.05em;">台中市西屯區推理大道 221B 號 B1</p>
                </div>
            </div>
            <div style="display: flex; gap: 1rem; align-items: flex-start; margin-bottom: 3rem;">
                <div style="width: 48px; height: 48px; background: #18181b; border: 1px solid rgba(255,255,255,0.05); border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 1.25rem; color: #dc2626;">📞</div>
                <div>
                    <h4 style="color: white; margin: 0 0 0.4rem 0; letter-spacing: 0.1em; font-size: 0.95rem;">預約專線</h4>
                    <p style="color: #6b7280; margin: 0; font-size: 0.85rem; letter-spacing: 0.05em;">04-2345-6789 (營業時間: 13:00 - 02:00)</p>
                </div>
            </div>
        ...
        <div style="flex: 1; min-width: 300px; position: relative; padding: 1rem;">
            ...
            <div style="position: absolute; bottom: -1rem; left: -1rem; background: black; padding: 1.5rem; border: 1px solid rgba(255,255,255,0.1); z-index: 20; box-shadow: 0 20px 40px rgba(0,0,0,0.8);">
                <p style="font-size: 1.5rem; font-family: serif; color: white; margin: 0; letter-spacing: 0.15em; line-height: 1.4;">"EVERY ROOM<br/>IS A STAGE."</p>
            </div>
        </div>
    </div>
</section>
